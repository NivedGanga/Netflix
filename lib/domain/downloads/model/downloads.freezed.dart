...
abstract class $DownloadsCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'original_language') String originalname,
...
class _$_Downloads implements _Downloads {
  const _$_Downloads(
      ...
      @JsonKey(name: 'original_language') required this.originalname,
  ...
  @override
  String toString() {
    return 'Downloads(posterPath: $posterPath, originalname: $originalname, backdropPath: $backdropPath)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, posterPath, originalname, backdropPath);
