...
mixin _$SearchState {
  ...
  List<Downloads> get ideaList => throw _privateConstructorUsedError;
...
class _$SearchStateCopyWithImpl<$Res, $Val extends SearchState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      ideaList: null == ideaList
          ? _value.ideaList
          : ideaList // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
...
class _$_SearchState implements _SearchState {
  const _$_SearchState(
      ...
      required final List<Downloads> ideaList,
  ...
  final List<Downloads> _ideaList;
  @override
  List<Downloads> get ideaList {
    if (_ideaList is EqualUnmodifiableListView) return _ideaList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_ideaList);
  }
  ...
  @override
  String toString() {
    return 'SearchState(searchResult: $searchResult, ideaList: $ideaList, isloading: $isloading, isError: $isError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._ideaList, _ideaList) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_ideaList),
      isloading,
      isError);
